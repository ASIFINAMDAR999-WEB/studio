                ...
                <div className="p-6 border rounded-lg bg-background/50">
                    ...
                    <div className="mt-4 p-4 bg-muted rounded-md text-sm">
                        ...
                        <ol className="list-decimal list-inside text-muted-foreground space-y-1 mt-2">
                          ...
                          <li>Create a CNAME record for your desired subdomain.</li>
                          <li>Point it to: <code className="bg-background px-1.5 py-0.5 rounded-sm font-mono text-primary">proxy.redarmor.net</code></li>
                        </ol>
                    </div>
                    <div className="mt-6 flex justify-end">
