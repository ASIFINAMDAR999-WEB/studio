  ...
  theme: {
    extend: {
      ...
      animation: {
        ...
        'scale-in-x': 'scale-in-x 0.4s ease-out var(--scale-delay) forwards',
        'scale-in-y': 'scale-in-y 0.4s ease-out var(--scale-delay) forwards',
        'glow-pulse': 'glow-pulse 0.8s ease-in-out forwards',
      },
    },
  },
